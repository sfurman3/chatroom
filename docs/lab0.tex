...
\begin{document}
	...
	Each server receives commands from a master and respond to that master. A list of these commands is shown in \autoref{tab:commands} and the responses are shown in \autoref{tab:commands2}.
